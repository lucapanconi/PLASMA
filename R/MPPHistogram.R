...
#' MPP Histogram
#' 
#' Produces a 2D histogram of GP values.
#' 
#' @param points Point pattern including photon counts in columns 3 and 4.
#' @param binsize Size of bins in histogram.
#' @return GP Histogram.
#' @export
mpphistogram <- function(points, binsize = 50, location = "", plotname = "GP Histogram", useggplot = FALSE, outputdata = FALSE){
