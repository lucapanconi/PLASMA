...
#' Toroidal Distance
#' 
#' Calculates distance between points on toroidal coordinate system.
#' 
#' @param points Point cloud.
#' @param domain_max_x Domain size in x direction.
#' @param domain_max_y Domain size in y direction.
...
#' Calculate L Values
#' 
#' Calculates Getis L Values function used in MPP Simulate.
#' 
#' @param distance_matrix Distance matrix of given point cloud.
#' @param domain_size_x Domain size in x direction.
#' @param domain_size_y Domain size in y direction.
#' @param number_of_points Number of points.
#' @param search_radius Search radius defining neighbourhood.
#' @return L Values.
#' @export
...
#' Velocity
#' 
#' Velocity function used to determine offset of randomly generated points in MPP Simulate.
#' 
#' @param points Point cloud.
#' @param domain_size_x Domain size in x direction.
#' @param domain_size_y Domain size in y direction.
#' @param number_of_points Number of points.
#' @param search_radius Search radius defining neighbourhood.
#' @param D_max Diffusivity multiplier for offset.
...
#' 
#' @param number_of_frames Number of frames to run initial simulation over.
#' @param number_of_points Number of points in initial simulation.
#' @param domain_size_x Domain size in x direction.
#' @param domain_size_y Domain size in y direction. Taken as same as x if omitted.
#' @param search_radius Search radius defining neighbourhood.
#' @param D_max Diffusivity multiplier for offset.
#' @param L_target Target L value.
#' @param tomato_threshold Threshold used in ToMATo clustering to determine domains. Will be automatically estimated if omitted.
#' @param grid_size Number of bins in each direction of grid which new point cloud is overlaid onto.
#' @param number_of_categories Number of different domain types (not including background).
#' @param number_of_resimulated_points Number of points in final MPP, will be same as number_of_points if omitted.
#' @param use_csr Boolean value dictating whether to use completely spatially random distribution. If TRUE, probabilities are ignored.
#' @param probability_of_picking_categories Vector of probabilities of assigning points to domain types.
#' @param precision_alpha Alpha parameter used in Gamma distribution to simulate localisation error.
#' @param precision_beta Beta parameter used in Gamma distribution to simulate localisation error.
#' @param category_mean Vector of mean values for different domain types
#' @param category_sd Vector of standard deviations for different domain types
#' @param background_mean Mean background value.
#' @param background_sd Background standard deviation.
#' @return Offset.
#' @export
...
#' Used in MPP Segment.
#' 
#' @param x Interval number.
#' @return Points in that interval.
#' @export
...
#' MPP Segment
#' 
#' Segments a large marked point pattern by disregarding all points outside of xlims and ylims (if given) and splitting into m×n equally spaced segments.
#' 
#' @param points Point pattern.
#' @param m Number of intervals in x direction.
#' @param n NUmber of intervals in y direction, will be same as x if omitted.
#' @param xlims Maximum x value.
#' @param ylims Maximum y value.
#' @return List of point clouds over given intervals.
#' @export
...
#' Save Segment
#' 
#' Used in Save Segments.
#' 
#' @param points Point pattern.
#' @return Saves image of segment.
#' @export
...
#' Save Segments.
#' 
#' Saves segments found by MPP Segment.
#' 
#' @param segmentation Output of MPP Segment.
#' @return Saves images of segments.
#' @export
...
#' Photon Simulate
#' 
#' Adds additional photon count estimations to a given simulated marked point pattern (if it does not have them already).
#' 
#' @param points Point pattern (including GP values in third column).
#' @param photons Vector if photon counts in first channel.
#' @return Point pattern with photon counts and GP values.
#' @export
...
#' Plot MPP
#' 
#' Plots a continuous marked point pattern.
#' 
#' @param points Point pattern.
#' @return Plot of points.
#' @export
...
#' Plot MPP Discrete
#' 
#' Plots a discrete marked point pattern, based on plotClusterScatter from RSMLM.
#' 
#' @param coords Point pattern.
#' @param clusterIndices Labels or cluster indices of points.
#' @return Plot of points.
#' @export
