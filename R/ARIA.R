...
#' Discretise
#' 
#' Converts continuous point cloud into a discrete point cloud.
#' 
#' @param points Continuous point cloud.
#' @param splits Split points for discretisation, will estimate by Gaussian Mixture Modelling if omitted.
#' @return Discrete point cloud.
#' @export
...
#' 
#' Estimates a good persistence threshold for ToMATo clustering.
#' 
#' @param points Point cloud.
#' @param radius Radius for determining neighbourhood.
...
#' 
#' Allows user to determine ARI value associated with the whole and individual partitions of the data set. 
#' 
#' @param points Point pattern.
#' @param clusterradius Radius for determining neighbourhood.
#' @param clusterperistence Persistence threshold for ToMATo.
...
#' Adjusted Rand Index Analysis
#' 
#' Outputs the ARI value and the estimated p-value associated with it for a given data set. 
#' 
#' @param points Point pattern.
#' @param clusterradius Radius for determining neighbourhood.
#' @param clusterperistence Persistence threshold for ToMATo.
#' @return Adjusted rand index and associated p value.
#' @export
